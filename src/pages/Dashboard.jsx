...
//               className="bg-white p-6 rounded-xl shadow hover:shadow-lg cursor-pointer transition hover:scale-[1.02]"
//             >
...
//             <h3 className="text-gray-500">Total Interviews</h3>
...
//           <div className="bg-white p-6 rounded-xl shadow">
//             <h3 className="text-gray-500">Weak Area</h3>
